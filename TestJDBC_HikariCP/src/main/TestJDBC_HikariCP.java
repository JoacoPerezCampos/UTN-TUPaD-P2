...
public class TestJDBC_HikariCP {
            ...
            try (Connection conn = HikariConnectionPool.getConnection()) {
                if (conn != null) {
                    ...
                    if (i == 1) {
                        ...
                        String sql = "SELECT codigo, nombre, apellido FROM Clientes";
                        ...
                        try (Statement stmt = conn.createStatement();
                            ...
                            while (rs.next()) {
                                int id = rs.getInt("codigo");           // Obtener columna 'codigo'
                                String nombre = rs.getString("nombre"); // Obtener columna 'nombre'
                                String apellido = rs.getString("apellido"); // Obtener columna 'precio'
